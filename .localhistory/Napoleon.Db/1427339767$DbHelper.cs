...
namespace Napoleon.Db
{
    public static class DbHelper
    {
        ...
        /// Author  : Napoleon
        /// Created : 2015-03-26 10:08:49
        public static void ExecuteProcedure(DynamicParameters parameters, string procedure)
        {
        ...
        public static int ExecuteProcedureOutInt(DynamicParameters parameters, string procedure, string intName)
        {
            int number;
            using (IDbConnection conn = OpenConnection())
            {
                SqlMapper.Execute(conn, procedure, parameters, null, null, CommandType.StoredProcedure);
                conn.Execute(procedure, parameters, null, null, CommandType.StoredProcedure);
