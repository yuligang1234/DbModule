...
namespace Napoleon.Db
{
    public static class DbHelper
    {
        ...
        /// </summary>
        /// <param name="procedure">存储过程名称</param>
        /// <param name="sql">参数(StrSql,StrWhere,OrderBy,RecordCount)</param>
        /// <param name="where">参数(StrSql,StrWhere,OrderBy,RecordCount)</param>
        /// <param name="intName">整型的参数名</param>
        /// Author  : Napoleon
        /// Created : 2015-03-25 16:25:26
        public static int ExecuteProcedureOutInt(string procedure, string sql, string where, string intName)
        {
            int number;
            using (IDbConnection conn = OpenConnection())
            {
            ...
            /*using (SqlConnection conn = OpenConnection())
            {
                ...
                cmd.Parameters.AddWithValue("@StrSql", sql);
                cmd.Parameters.AddWithValue("@StrWhere", where);
                cmd.Parameters.Add("@RecordCount", SqlDbType.Int).Direction = ParameterDirection.Output;
                cmd.ExecuteNonQuery();
                number = (int)cmd.Parameters[intName].Value;
            }*/
            return number;
        }
